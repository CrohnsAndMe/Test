...
BaseTank* TankManager::GetTankObject(SDL_Renderer* renderer, TankSetupDetails details)
{
	...
	else if (details.StudentName == "S013010CTank")
	{
		S013010C_Aaron_Smith_Tank* newControlledTank = new S013010C_Aaron_Smith_Tank(renderer, details,false);
		newBaseTank = (BaseTank*)newControlledTank;
	}
	else if (details.StudentName == "S013010CTestTank")
	{
		TestTank* newControlledTank = new TestTank(renderer, details,true);
		newBaseTank = (BaseTank*)newControlledTank;
	}
